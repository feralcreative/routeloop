...
**Branch:** `feat/on-the-road` ([#69](https://github.com/feralcreative/routeloop/issues/69))—the on-the-road page, send-to-device, and the service worker, 2026-09-14, three commits. **3,062 tests across 120 files** (2 skipped). No migration. **Not yet driven on a phone**—see the checklist below.
