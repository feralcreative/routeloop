...
**Branch:** `feat/mute-notifications` ([#402](https://github.com/feralcreative/routeloop/issues/402), [#403](https://github.com/feralcreative/routeloop/issues/403))—mute any notification kind from Preferences or from an STFU sign in the notification center; muted rows land already read, with no badge, popup or email. Short names for every kind. No migration. Cut from `main` after #401 merged. **3,140 tests across 126 files** (3 skipped, 3,143 total).
