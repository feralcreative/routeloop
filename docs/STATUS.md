...
**Merged 2026-09-09 as [#302](https://github.com/feralcreative/routeloop/pull/302) and [#303](https://github.com/feralcreative/routeloop/pull/303):** release notes as notifications, then the icon workbench, the notification mark colors and the nav badge. `main` is `a9126eb`.
