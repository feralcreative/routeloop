...
| `GET /`                            | The dashboard—hero miles, tiles, storage meter, records, twelve-month chart from `src/stats/`, and a count with one link to `/rides`. `routes/home.tsx`. The ride lists lived here from 2026-08-24 to 2026-09-15 |
