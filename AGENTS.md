...
- **Production is not precious, its mechanics are.** Three accounts, all the owner's. Be careful with how a migration runs, not about whether to do one—deferring a schema change out of caution once shipped imports that destroyed multi-day structure.
