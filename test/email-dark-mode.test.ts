...
describe('the wordmark', () => {
  const LIGHT = `${APP_ORIGIN}/img/logo-tankbag-email-horiz.png`
  const DARK_SRC = `${APP_ORIGIN}/img/logo-tankbag-email-horiz-dark.png`
  ...
  it('puts the wordmark in alt text on both copies', () => {
    ...
    for (const alt of alts) expect(alt).toBe('tankbag.')
  })
...
describe('the logo assets', () => {
  ...
  it('the dark logo is drawn on the dark card color', () => {
    expect(groundOf('_assets/logo-tankbag-email-horiz-dark.png')).toBe('#000000')
    expect(DARK.cardBg).toBe('#000')
  })

  it('the light logo is drawn on the light card color', () => {
    expect(groundOf('_assets/logo-tankbag-email-horiz.png')).toBe('#ffffff')
  ...
  for (const name of ['logo-tankbag-email-horiz.png', 'logo-tankbag-email-horiz-dark.png']) {
